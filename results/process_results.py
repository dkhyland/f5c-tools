...
create_profile
============================================================================================================
create a .profile file from f5c output
"""
def create_profile():
    parser = argparse.ArgumentParser()
    parser.add_argument('param_file',help='Full path to the parameters.txt file that contains parameters and results for different tests')
    ...
    #.profile file doesn't exist so create one
...
parser = argparse.ArgumentParser(
    ...
    modes:
            'create_profile' :     (for creating a .profile file from an f5c output file)
    ...
    usage:
            'create_profile [output file]'
                [output file] :        (path to the raw.txt or useful.txt file which contains the parameters to be stored)
